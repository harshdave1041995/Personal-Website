<template>
  <div class="intro-container">
    <div id="intro" class="section intro">
      <div class="intro-line animated fadeInDown delay-1s">Hi, my name is</div>
      <div class="name animated fadeInDown delay-2s">Harsh Dave.</div>
      <div class="subheading animated fadeInUp delay-3s">
